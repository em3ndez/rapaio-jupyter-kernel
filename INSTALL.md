...
* `java -jar ./rapaio-jupyter-kernel-4.0.0.jar -i -auto -preview22` - enables preview features for Java 22 release.
* `java -jar ./rapaio-jupyter-kernel-4.0.0.jar -i -auto -preview23` - enables preview features for Java 23 release.
* `java -jar ./rapaio-jupyter-kernel-4.0.0.jar -i -auto -preview24` - enables preview features for Java 24 release.
* `java -jar ./rapaio-jupyter-kernel-4.0.0.jar -i -auto -preview25` - enables preview features for Java 25 release.
* `java -jar ./rapaio-jupyter-kernel-4.0.0.jar -i -auto -preview26` - enables preview features for Java 26 release.
...
An example of interactive installer mode:
    ...
    shell: java -jar ./rapaio-jupyter-kernel-4.0.0.jar -i
    ...
    Select display name (default 'Java (rjk 4.0.0)'):
    ...
    "java",
    "-jar",
    "/home/ANT.AMAZON.COM/tutuianu/.local/share/jupyter/kernels/rapaio-jupyter-kernel/rapaio-jupyter-kernel-4.0.0.jar",
    "{connection_file}"
    ],
    "display_name": "Java (rjk 4.0.0)",
    "language": "java",
