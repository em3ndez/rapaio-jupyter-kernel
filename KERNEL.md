...
The changed kernel file looks like the following:

    {
        "argv": [
            ...
            "-jar",
            "/home/ANT.AMAZON.COM/tutuianu/.local/share/jupyter/kernels/rapaio-jupyter-kernel-preview25/rapaio-jupyter-kernel-4.0.0.jar",
            "{connection_file}"
        ],
        "display_name": "Java (rjk 4.0.0 preview26)",
        "language": "java",
        "interrupt_mode": "message",
        "env": {
            "RJK_CLASSPATH": "",
...
An illustrative example you can found below:

    {
        "argv": [
            "java",
            "-jar",
            "/home/ANT.AMAZON.COM/tutuianu/.local/share/jupyter/kernels/rapaio-jupyter-kernel-preview23/rapaio-jupyter-kernel-4.0.0.jar",
            "{connection_file}"
        ],
        "display_name": "Java (rjk 4.0.0)",
        "language": "java",
